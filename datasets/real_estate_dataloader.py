...
import utils.RealEstate_utils as extended_transforms
from utils.RealEstate_utils import make_dataset


class RealEstate(data.Dataset):
...
class RealEstateDataLoader:
    def __init__(self, config):
        ...
        if self.config.mode == 'random':
            ...
            train_set = RealEstate('train', self.config.data_root,
                            transform=self.input_transform, target_transform=self.target_transform)
            valid_set = RealEstate('val', self.config.data_root,
                            transform=self.input_transform, target_transform=self.target_transform)
            ...
            test_set = RealEstate('test', self.config.data_root,
                           transform=self.input_transform, target_transform=self.target_transform)
